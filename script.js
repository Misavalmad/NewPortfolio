...
function processCommand(command) {
    ...
    const commands = {
        ...
        'about': `Full Stack Web Developer with a strong foundation in Computational Technologies Engineering. I specialize in creating modern, responsive web applications using JavaScript, React, and cutting-edge technologies. My passion lies at the intersection of elegant code architecture and user-centric design, always seeking to deliver seamless digital experiences.`,
        ...
        'projects': `1. <span>Weather Dashboard:</span> Interactive weather app with real-time API data.\n2. <span>Calculator App:</span> Web calculator with clean UI and smooth functionality.\n3. <span>Generador de Loteria Familiar:</span> Family lottery generator with playful visuals.\n4. <span>Proyecto Hackaton Relax Inc:</span> Hackathon project focused on a calm UX.\n5. <span>Lolo's Cafe E-Commerce:</span> Online shop experience with a clean product flow.\n\nView all projects: <a href="https://github.com/Misavalmad?tab=repositories" target="_blank" class="text-secondary-neon">github.com/Misavalmad</a>`,
